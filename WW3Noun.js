...
//INSERT NOUN FORMS HERE
  //const nounList = [["patria", "patriae", "f", "fatherland", "countries"],["puella", "puellae", "f", "girl", "girls"],["poēta", "poētae", "m", "poet", "poets"],["nauta", "nautae", "m", "sailor", "sailors"],["fama", "famae", "f", "rumor", "rumors"],["forma", "formae", "f", "shape", "forms"],["fortuna", "fortunae", "f", "luck", "fortunes"],["īra", "īrae", "f", "anger", "angers"],["pecūnia", "pecūniae", "f", "money", "monies"],["philosophia", "philosophiae", "f", "philosophy", "philosophies"],["porta", "portae", "f", "gate", "gates"],["rosa", "rosae", "f", "rose", "roses"],["sententia", "sententiae", "f", "opinion", "opinions"],["vita", "vitae", "f", "life", "lives"]];
  ...
  let nounList = [["ager", "agri", "m","field", "fields"],["amīcus", "amīci", "m","friend","friends"],["fīlius", "fīlii", "m","son","sons"],["numerus", "numeri", "m","number","numbers"],["populus", "populi", "m","people", "nations"],["amīca", "amīcae", "f","girl friend","girl friends"],["agricola", "agricolae", "m","farmer","farmers"],["fēmina", "fēminae", "f","woman","women"],["fīlia", "fīliae", "f","daughter","daughters"],["sapientia", "sapientiae", "f","wisdom","wisdoms"],["puer", "pueri", "m","boy","boys"],["vir", "viri", "m","man", "men"]];
